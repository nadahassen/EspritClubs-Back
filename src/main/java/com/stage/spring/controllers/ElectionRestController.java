...
public class ElectionRestController {
   ...
   /* @PostMapping("/addElection")
    ...
    @PostMapping("/addElection")
    public void addElection(@RequestParam("election") String election,
                         @RequestParam("file") MultipartFile file

    )
            throws IOException
    {
        Election f = new ObjectMapper().readValue(election, Election.class);
        serviceElection.addElection(f,file);
    }
